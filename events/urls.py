...
from .views import event_detail_view, events_view, category_view, venues_view, venue_detail_view, search_venues_view, church_or_group_view, search_events_view, venue_events_view, month_events_view, county_view
